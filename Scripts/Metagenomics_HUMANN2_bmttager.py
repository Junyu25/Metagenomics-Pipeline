...
def m2_run_kneaddata(nnodes, F_list,R_list,script_path, trimmomatic_path, refdb_path):
    """
    ...
    --run-bmtagger --remove-intermediate-output' \
     ::: %s ::: %s" % (nnodes, refdb_path, trimmomatic_path, F_list, R_list))
...
if __name__ == '__main__':
    ...
    if pair_end == 'True':
        m2_run_kneaddata(nnodes, F_list,R_list,script_path, trimmomatic_path, refdb_path)
    else:
