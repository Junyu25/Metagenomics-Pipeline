...
def m3_humann2(nnodes, script_path,njobs):
    ...
    os.system('humann2_config --update database_folders protein /home/LDlab/DataBases/HUMAnN2/uniref')
    os.system('humann2_config --update database_folders nucleotide /home/LDlab/DataBases/HUMAnN2/chocophlan')
    import math
