...
def m3_humann2(nnodes, script_path,njobs):
    ...
    os.system('humann2_config --update database_folders protein /home/junyuchen/Lab/Custom-DataBase/ICEBerg/DataBase/ICE_aa_all')
    import math
    nthread=str(int(math.ceil(float(int(nnodes))/int(njobs))))
    #this is the most time consuming step
    os.system("parallel -j %s 'humann2 --threads %s --remove-temp-output --bypass-nucleotide-index --nucleotide-database /home/junyuchen/Lab/Custom-DataBase/VFDB/DataBase/VFDB-2019-12-20 --id-mapping /home/junyuchen/Lab/Custom-DataBase/VFDB/id-mapping-VF.tsv --input {} --output humann2_out/{/.}' ::: cat_reads/*fastq" % (njobs,nthread))
