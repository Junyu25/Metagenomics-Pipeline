...
def m3_humann2(nnodes, script_path,njobs):
    ...
    os.system('mkdir humann2_CAZy-out')
    os.system('humann2_config --update database_folders protein /home/junyuchen/Lab/Custom-DataBase/CAZy')
    import math
    nthread=str(int(math.ceil(float(int(nnodes))/int(njobs))))
    #this is the most time consuming step
    os.system("parallel -j %s 'humann2 --threads %s --bypass-nucleotide-search --remove-temp-output --id-mapping /home/junyuchen/Lab/Custom-DataBase/CAZy/id-mapping-CAZy-gf.tsv --input {} --output humann2_CAZy-out/{/.}' ::: cat_reads/*fastq" % (njobs,nthread))
    #3.2 Merge individual sample data together
    os.system('mkdir humann2_CAZy-final_out')
    os.system('humann2_join_tables -s --input humann2_CAZy-out/ --file_name pathabundance --output humann2_CAZy-final_out/humann2_pathabundance.tsv')
    os.system('humann2_join_tables -s --input humann2_CAZy-out/ --file_name pathcoverage --output humann2_CAZy-final_out/humann2_pathcoverage.tsv')
    os.system('humann2_join_tables -s --input humann2_CAZy-out/ --file_name genefamilies --output humann2_CAZy-final_out/humann2_genefamilies.tsv')
    ...
    os.system('humann2_renorm_table --input humann2_CAZy-final_out/humann2_pathabundance.tsv --units cpm --output humann2_CAZy-final_out/humann2_pathabundance_cpm.tsv')
    os.system('humann2_renorm_table --input humann2_CAZy-final_out/humann2_genefamilies.tsv --units cpm --output humann2_CAZy-final_out/humann2_genefamilies_cpm.tsv')
    ...
    os.system('humann2_split_stratified_table --input humann2_CAZy-final_out/humann2_pathabundance_cpm.tsv --output humann2_CAZy-final_out')
    os.system('humann2_split_stratified_table --input humann2_CAZy-final_out/humann2_genefamilies_cpm.tsv --output humann2_CAZy-final_out')
    os.system('humann2_split_stratified_table --input humann2_CAZy-final_out/humann2_pathcoverage.tsv --output humann2_CAZy-final_out')
    ...
    os.system("sed 's/_Abundance-RPKs//g' humann2_CAZy-final_out/humann2_genefamilies_cpm_unstratified.tsv | sed 's/# Gene Family/GeneFamily/' > humann2_CAZy-final_out/humann2_genefamilies_cpm_unstratified.spf")
    os.system("sed 's/_Abundance//g' humann2_CAZy-final_out/humann2_pathabundance_cpm_unstratified.tsv | sed 's/# Pathway/Pathway/' > humann2_CAZy-final_out/humann2_pathabundance_cpm_unstratified.spf")
