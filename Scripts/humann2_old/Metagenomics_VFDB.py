...
def m3_humann2(nnodes, script_path,njobs):
    ...
    os.system("parallel -j %s 'humann2 --threads %s --bypass-nucleotide-index --nucleotide-database /home/junyuchen/Lab/Custom-DataBase/VFDB/DataBase/VFDB-2019-12-20 --remove-temp-output --input {} --output humann2_out/{/.}' ::: cat_reads/*fastq" % (njobs,nthread))
