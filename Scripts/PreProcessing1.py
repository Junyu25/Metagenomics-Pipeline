...
def m1_fastqc(ALL_list):
    ...
    if not os.path.isdir('fastqc_out'):
        ...
        os.system('fastqc -t 16 %s -o fastqc_out/' % ALL_list)
    else:
...
def m2_run_kneaddata(nnodes, F_list,R_list,script_path):
    ...
    -t 7 --trimmomatic-options \"SLIDINGWINDOW:4:20 MINLEN:50\" \
...
def m3_humann2(nnodes, script_path):
    """
    :nnodes: the number of nodes to parallel
    :script_path: the path of custome script, default is /home/yxtan/HUMANN2_SOP_scripts/
    :return: None
    ...
    os.system("parallel -j 1 'humann2 --threads %s --bypass-nucleotide-index --nucleotide-database /home/junyuchen/Lab/Custom-DataBase/VFDB/Bowtie2-Index_VFDB_setB_nt --id-mapping /home/junyuchen/Lab/Custom-DataBase/VFDB/DataBase/VFDB-2019-12-20/id-mapping-VFDB-2019-12-20.tsv --input {} --output humann2_out/{/.}' ::: cat_reads/*fastq" % (nnodes))
